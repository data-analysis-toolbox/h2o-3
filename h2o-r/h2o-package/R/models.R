...
#'
#' Calculates row-wise variable importances by re-scoring a trained supervised model and measuring the impact of setting
#' each variable to missing or it’s most central value(mean or median & mode for categoricals)
...
#'         the new prediction (when a variable is dropped/replaced with mean/median/mode).
#' @examples
#' \donttest{
#' library(h2o)
#' h2o.init()
